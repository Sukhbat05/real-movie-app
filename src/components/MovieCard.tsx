...
const MovieCard = ({ movie }: { movie: Movie }) => {
  ...
  return (
    <div
      onClick={hanldeRoute}
      className="h-[430px] bg-secondary    relative #F4F4F5 cursor-pointer transform hover:scale-105 transition duration-200 ease-out hover:drop-shadow-lg m-5 max-sm:w-[150px] max-sm:h-[300px] max-sm:m-2"
    >
